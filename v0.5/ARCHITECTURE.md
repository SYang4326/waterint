# WaterInt v0.5 Architecture

WaterInt v0.5 keeps the v0.4 separation between input, domain helpers, scientific computation, output, workflow orchestration, and UI code. It adds a Nernst--Einstein conductivity module built on the MSD computation path.
...
The inherited v0.4 native layer includes:
...
v0.5/example/<method>/                  example config and expected outputs
