...
from waterint._05_ui.core import comma_list, run_analysis, type_map_yaml, yaml_string
...
EXAMPLES = {
    "density": {
        "base_dir": "v0/example/mgo_density",
        "trajectory": "../shared/input/dump.MgO_water_2x2_equil.last100ps.unique.waterint.npz",
        "format": "npz",
        "system_cell": "auto",
        "type_map": "1: H\n2: Mg\n3: O",
        "fields": {
            "coord_range": "[-1.0, 30.0]",
            "coord_bins": "310",
            "species": "OH-, H2O",
            "normalization": "mass_density",
            "prefix": "ui_mgo_density",
        },
    },
    "oh-orientation": {
        "base_dir": "v0/example/mgo_oh_orientation",
        "trajectory": "../shared/input/dump.MgO_water_2x2_equil.last100ps.unique.waterint.npz",
        "format": "npz",
        "system_cell": "auto",
        "type_map": "1: H\n2: O\n3: Mg",
        "fields": {
            ...
            "angle_bins": "180",
            "prefix": "ui_mgo_oh_orientation",
        },
    },
    "hbond": {
        "base_dir": "v0/example/mgo_hbond",
        "trajectory": "../shared/input/dump.MgO_water_2x2_equil.last100ps.unique.waterint.npz",
        "format": "npz",
        "system_cell": "auto",
        "type_map": "1: H\n2: Mg\n3: O",
