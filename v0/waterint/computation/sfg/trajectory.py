...
from waterint.computation.sfg.processing import write_cf
from waterint.core.selection import SelectionContext, element_indices, element_mask
from waterint.workflows.common import iter_frames, parse_cell, resolve_path
...
def _zref_series(frames: list[TrajectoryFrame], sfg_cfg: dict[str, Any], context: SelectionContext) -> np.ndarray:
